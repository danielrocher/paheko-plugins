...
<section class="stock">
	...
	<article class="etiquettes">
		...
		<p>
			...
			<a href="fiche.php?id={$r.id}" class="a_demonter">{if $r.id}{$r.id}{else}&#x1F6B2;{/if}</a>
			{/foreach}
		</p>
	</article>
	<article class="etiquettes">
		...
		<p>
			...
			<a href="fiche.php?id={$r.id}" class="en_vente">{if $r.id}{$r.id}{else}&#x1F6B2;{/if} <i>{$r.prix}&nbsp;€</i></a>
			{/foreach}
		</p>
	</article>
	<article class="etiquettes">
		...
		<p>
			...
			<a href="fiche.php?id={$r.id}" class="en_stock">{if $r.id}{$r.id}{else}&#x1F6B2;{/if}</a>
			{/foreach}
		</p>
	</article>
